...
import { ArrowRight, LayoutTemplate, Monitor, Code2, CheckCircle2 } from 'lucide-react';
...
export function Services() {
  return (
    <div className="pt-12 pb-32 relative overflow-hidden bg-industrial-950">
      {/* Background glow */}
        ...
        <div className="flex flex-col gap-12">
          {services.map((service, index) => (
            <motion.div
              ...
              className={`group relative flex flex-col lg:flex-row gap-8 lg:gap-16 p-8 md:p-12 border transition-all duration-500 overflow-hidden ${
                service.highlight 
            ...
            >
              ...
              <div className="absolute -right-8 -bottom-12 text-[240px] font-bold font-mono text-industrial-800/20 group-hover:text-industrial-700/20 transition-colors duration-500 pointer-events-none select-none leading-none z-0">
                0{index + 1}
              </div>
              ...
              <div className="lg:w-1/3 flex flex-col relative z-10">
                ...
                <h2 className="text-3xl md:text-4xl font-bold text-white mb-4 leading-tight tracking-tight group-hover:text-accent-50 transition-colors">{service.title}</h2>
              </div>
              
              {/* Right Column: Description, Features, Price, CTA */}
              <div className="lg:w-2/3 flex flex-col relative z-10">
                <p className="text-industrial-400 mb-10 leading-relaxed font-light text-xl max-w-3xl">
                  {service.description}
                </p>
                ...
                <div className="mt-auto pt-8 border-t border-industrial-800/50 flex flex-col sm:flex-row sm:items-center justify-between gap-6">
                  <div>
                    ...
                    <span className="text-3xl font-mono text-white tracking-wider font-bold">{service.price}</span>
                  </div>
